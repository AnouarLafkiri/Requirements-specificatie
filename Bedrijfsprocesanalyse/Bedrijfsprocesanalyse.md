# Bedrijfsprocessanalyse — BI-Rapportageproces
**Chocolate Firm | Ist · Soll · Knelpunten · Gap-analyse · SIPOC**
...
|---|---|---|---|---|
| *Wie levert input?* | *Welke data/materiaal?* | *Processtappen* | *Wat wordt opgeleverd?* | *Wie ontvangt output?* |
...
| Externe marktdata (optioneel) | Productiecijfers automatisch | 4. Dashboard automatisch vernieuwd | Exportmogelijkheid (PDF/Excel) | Inkoop / Verkoop |
| | | 5. Gebruiker opent BI-tool (self-service) | Alerts bij afwijkende KPI's | Productontwikkeling |
| | | 6. Filter/drill-down op eigen data | | |
...
De overige gaps (beveiliging, adoptie, schaalbaarheid) zijn oplosbaar binnen de bestaande kaders van een open source BI-tool zoals Apache Superset of Metabase, mits de implementatie gefaseerd wordt uitgevoerd en eindgebruikers vroeg worden betrokken. De verwachte tijdsbesparing van ~95% per rapportagecyclus rechtvaardigt de investering zelfs bij een minimaal budget.
